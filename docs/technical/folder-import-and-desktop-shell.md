...
| 文档版本 | v1.1 |
| 修订日期 | 2026-05-21 |
| 对齐 PRD | **v4.1 / `0.1.0-alpha` Desktop Alpha** §5.3.2.2、§5.3.7、F-RT-007b/c、§8.5 |
| 参考实现 | [Open Design architecture](../../参考项目/open-design/docs/architecture.md)、`apps/desktop`、`POST /api/import/folder` |
| 关联契约 | [companion-api.md](./companion-api.md)、[chat-execution-roadmap.md](../plans/chat-execution-roadmap.md)、[技术方案.md](./技术方案.md) §3.4 |
...
flowchart TB
  ...
  subgraph desktop [Electron Desktop Alpha 主路径]
    R[渲染进程 Web UI]
...
| 桌面 HMAC（Desktop Beta+） | 带 `X-JLC-Desktop-Import-Token` 的请求可打标 `fromTrustedPicker: true` |
...
| 阶段 | 交付 |
|------|------|
| **`0.1.0-alpha` / Desktop Alpha** | **Electron 主路径**：`pickAndImportFolder` + load `web/`；Companion `import-folder`；Web 手填路径为**无壳降级** |
| **`0.2.0-beta` / Desktop Beta** | HMAC、托盘、Companion 安装检测、electron-builder 签名分发 |
...
完整排期见 [chat-execution-roadmap.md](../plans/chat-execution-roadmap.md) §S2.3、§S4。
...
| 文档 | 路径 |
|------|------|
| `0.1.0-alpha` / Desktop Alpha | `docs/product/PRD-小窗.md` §10.2 |
| Companion API | `docs/technical/companion-api.md` |
| 技术方案 §3.4 | `docs/technical/技术方案.md` |
| 功能清单 F-RT-007c | `docs/product/功能清单.md` |
