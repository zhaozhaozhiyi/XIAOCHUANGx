...
| 审计范围     | [PRD-小窗.md](../product/PRD-小窗.md)、[技术方案.md](../technical/技术方案.md)、[功能清单.md](../product/功能清单.md)、[需求整理.md](../product/需求整理.md)、[docs/](../README.md)、[api/README.md](../../api/README.md)、`module-registry` / Companion 契约、Skills 资产 |
...
| **PRD**  | [§5.3.2.1a「新建 vs 分支」表](../product/PRD-小窗.md)、§6.0.3、F-RT-007、OQ-15；差异 **D-26**  |
...
| **涉及文件** | PRD §5.3.2.1a、§5.3.2.1c、[技术方案.md](../technical/技术方案.md) §5.1.1 |
...
| **涉及文件** | PRD §11 OQ-19、[meeting-module-prd.md](../archive/meeting-module-prd.md) OQ-MM-03 |
...
| -------- | --- | ---------------------------------------------------------------------------------------- | -------------------------------------------------- | -------------------------------------------------- | ---- |
| **S-01** | 🔴  | [功能清单.md](../product/功能清单.md) L62、L205                                                           | 「B 默认 sandbox」「沙箱=模式 B 默认」                         | 改为「B 未选项目 → §5.3.2.1a 平台默认工作区」                     | ✅ |
| **S-02** | 🔴  | [mvp-closure-checklist.md](../plans/mvp-closure-checklist.md) W1                      | 验收「仍用 sandbox projectId」                           | 改为「按 §5.3.2.1a 创建任务目录」                             | ✅ |
| **S-03** | 🔴  | [companion-api.md](../technical/companion-api.md) §2                                      | `POST /v1/projects` 仅 sandbox；无 ensure-default API | 新增 `POST /v1/projects/ensure-default-task-project` | ✅ |
| **S-04** | 🔴  | [folder-import-and-desktop-shell.md](../technical/folder-import-and-desktop-shell.md) L75 | sandbox-default                                    | 指向 §5.3.2.1a / `ensure-default-task-project`       | ✅ |
| **S-05** | ✅   | PRD §6.1 L859                                                                            | 曾写沙箱 projectId                                     | **已改** v3.6.1                                      | ✅    |
| **S-06** | ✅   | PRD 分支规则                                                                                 | 曾新建 vs 继承冲突                                        | **已决** v3.6.1 §5.3.2.1a                            | ✅    |
| **S-07** | 🟠  | [chat-skill-orchestration-analysis.md](../technical/chat-skill-orchestration-analysis.md) | 沙箱项目定义过时                                           | 更新为平台默认工作区                                         | ✅ |
| **S-08** | 🟠  | [README.md](../README.md)                                                                | 仍写 PRD v3.5                                        | 改为 v3.6.7                                          | ✅ |
| **S-09** | 🟠  | [技术方案.md](../technical/技术方案.md) 头信息                                                                | 关联 PRD v3.5                                        | 升 v1.5，关联 v3.6.7                                   | ✅ |
| **S-10** | 🟠  | [docs/product/需求整理.md](../product/需求整理.md) L165                                                               | 分支继承（与 PRD 一致）                                     | 已同步为 XIAOCHUANG 平台默认                                | ✅ |
...
| ID       | 优先级 | 建议动作                                                | 说明                                           | 你的决定 |
| -------- | --- | --------------------------------------------------- | -------------------------------------------- | ---- |
| **N-01** | 🔴  | 新建 `docs/technical/workspace-architecture.md`             | XIAOCHUANG 目录树、新建 vs 分支、UI 分组 vs projectId   | ✅ |
| **N-02** | 🔴  | 扩充 [companion-api.md](../technical/companion-api.md) | `ensure-default-task-project` 契约（**S-03 已写入**）             | ✅ |
| **N-03** | 🟠  | 新建 `docs/archive/writing-module-prd.md`                 | 写作模块子 PRD                                    | ✅ |
| **N-04** | 🟠  | 新建 `docs/archive/ppt-module-prd.md`                     | PPT 模块子 PRD                                  | ✅ |
| **N-05** | 🟠  | [docs/README.md](../README.md) 索引      | 加入 meeting-module-prd、workspace-architecture | ✅ |
| **N-06** | 🟠  | [skills/README.md](../../skills/README.md) 落地状态表       | PRD 引用 Skill vs 仓库是否存在                       | ✅（详表见审计 **§5**） |
| **N-07** | 🟡  | [UI设计规范-Claude风格.md](../design/UI设计规范-Claude风格.md)          | 默认工作区路径展示、空态                                 | ✅ |
...
- 平台默认工作区：[PRD §5.3.2.1a](../product/PRD-小窗.md) · [workspace-architecture.md](../technical/workspace-architecture.md)
- 新建 vs 分支（已决）：PRD §5.3.2.1a 表格
- 不使用项目映射：[PRD §12.5.3](../product/PRD-小窗.md)
- 会议模块：[docs/archive/meeting-module-prd.md](../archive/meeting-module-prd.md)
- 写作 / PPT：[writing-module-prd.md](../archive/writing-module-prd.md) · [ppt-module-prd.md](../archive/ppt-module-prd.md)
