...
| 适用产品 | 小窗（当前 **`0.1.0-alpha` / Desktop Alpha 以对话 + 桌面壳为主**；后续收口四模块） |
| 关联文档 | [docs/product/PRD-小窗.md](../product/PRD-小窗.md)（v4.1）、[workspace-architecture.md](../technical/workspace-architecture.md) |
