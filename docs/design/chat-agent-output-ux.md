...
| 创建日期 | 2026-05-21 |
| 状态 | **待实施（P1）** |
| 关联 | [chat-message-parts.md](../technical/chat-message-parts.md)、[chat-execution-roadmap.md](../plans/chat-execution-roadmap.md)、[agent-cli-activity-mapping.md](../technical/agent-cli-activity-mapping.md)、PRD **F-QA-007/010** |
...
| `docs/plans/chat-execution-roadmap.md` | 登记 **S3.5a** |
...
与 [agent-cli-activity-mapping.md](../technical/agent-cli-activity-mapping.md) 对齐，族 → 中文计数单位：
...
| `docs/technical/agent-cli-activity-mapping.md` | 补充族映射表 |
...
| `docs/plans/chat-execution-roadmap.md` | **S3.5b/c** |
