...
export const runEventSchema = z.discriminatedUnion("type", [
  ...
  z.object({
    ...
    injectedSkills: z.array(z.string()).nullable().optional(),
    missingSkills: z.array(z.string()).nullable().optional(),
    catalogMissingSlugs: z.array(z.string()).nullable().optional(),
    skillsRoot: z.string().optional(),
    promptsRoot: z.string().optional(),
    agentKitPath: z.string().nullable().optional(),
    timeoutProfile: z.string().optional(),
