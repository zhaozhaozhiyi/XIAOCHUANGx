---
slug: skill-vp-video-stage
version: "0.1"
kind: workflow
scope: ["chat","video"]
summary: "视频舞台生产：从文章或口播稿生成 Vite/React video-stage 项目，支持 ?reel=1 自动预览、?audio=1 配音检查、?auto=1 录屏出片路径"
skillDependencies: []
...
```bash
bash <path-to-video-stage>/scripts/scaffold.sh \
  ./presentation \
  --theme=<用户选的主题 id>
