...
#
# 例子：
#   bash <path-to-video-stage>/scripts/scaffold.sh ./presentation
#   bash <path-to-video-stage>/scripts/scaffold.sh ./talk --theme=paper-press
#   bash <path-to-video-stage>/scripts/scaffold.sh --list-themes
#
# 跑完后，看 SKILL.md "Phase 2.4 实现单章" + references/CHAPTER-CRAFT.md
# 了解每章怎么写。卡壳时翻 references/EXAMPLES/ 找完整章节 anchor。
#
# 之后切换主题，覆盖一个文件即可：
#   cp <path-to-video-stage>/themes/<id>/tokens.css \
