# BYOK + Handoff · V1.1 实现状态（2026-06-08）

| 属性 | 内容 |
|------|------|
| 文档版本 | v0.1 |
| 修订日期 | 2026-06-08 |
| 上级文档 | [PRD-小窗.md §F-RT-002 / §F-RT-009-B](../../PRD-小窗.md) |
...
把 PRD 中 F-RT-002 + F-RT-009-B 的全量需求拆为 **V1.1 桌面单机最小闭环** 与 **V1.1 后期 polish / V2.0**：

| 段 | V1.1 桌面单机最小闭环 | V1.1 后期 polish | V2.0 |
|----|----------------------|------------------|------|
...
**砍 V2.0 的理由**（对齐 [memory: V1.1 范围聚焦桌面端](file:///C:/Users/74179/.claude/projects/D--XIOACHUANGPRO/memory/v1.1-scope-desktop-only.md)）：admin gate、Postgres 加密存储、audit 日志、配额面板都依赖 Nest 多用户后台，与"本机单用户 + Companion"形态正交。
