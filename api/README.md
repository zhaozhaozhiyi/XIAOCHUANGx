...
云端业务服务：账号登录、研究项目元数据、对话会话元数据。执行面（Companion / Runtime）为独立服务，见 [docs/technical/技术方案.md](../docs/technical/技术方案.md)。

**`0.1.0-alpha` 数据分工：** 消息正文与 Agent 执行在 **Companion**；本服务管账号与会话**索引**。写作/PPT/翻译等业务任务（Desktop Beta）：**索引在本服务，正文权威在 `projectId` 工作区**（§6.0.4）。详见 PRD [§8.6](../docs/product/PRD-小窗.md#86-会话项目与消息的数据分工mvp)、[§6.0.4](../docs/product/PRD-小窗.md#604-业务历史与正文权威源已决v367--d-31)。
