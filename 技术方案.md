...
| 创建日期 | 2026-05-21 |
| 修订日期 | 2026-05-23 |
| 文档状态 | **已定稿（MVP v3.5：对话 + 桌面壳）** |
| 关联文档 | [PRD-小窗.md](./PRD-小窗.md)（v3.5 §8.6）、[功能清单.md](./功能清单.md)、[web/docs/mvp-closure-checklist.md](./web/docs/mvp-closure-checklist.md)、[web/docs/hermes-client.md](./web/docs/hermes-client.md) |
...
| **Artifact-first** | 模块闭环以 `projectId` 工作区内可持久化文件为准；Web 只展示与触发，不替代执行面 |
...
| 文件 | 直接读写 `sandbox` / `local_bound` 根目录 | `import-folder` 绑定不复制；`realpath` + 主目录边界（PRD §5.3.2.2、§7.6） |
...
| 模式 A 云端运行时 | §4.4 TS Runtime + K8s + OSS |
